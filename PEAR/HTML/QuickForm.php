...
require_once('Pear/HTML/Common.php');
...
$GLOBALS['HTML_QUICKFORM_ELEMENT_TYPES'] = 
        array(
            ...
            'tmce'			=>array('HTML/QuickForm/tmce.php','HTML_QuickForm_tmce'),
            'tmcearea'		=>array('HTML/QuickForm/tmcearea.php','HTML_QuickForm_tmcearea'),
...
class HTML_QuickForm extends HTML_Common {
    ...
    {
        include_once('Pear/HTML/QuickForm/RuleRegistry.php');
    ...
    function &_loadElement($event, $type, $args)
    {
        ...
        $includeFile = 'Pear/' . $GLOBALS['HTML_QUICKFORM_ELEMENT_TYPES'][$type][0];
        //die($className . '<br />' . $includeFile);
